...
(function () {
    ...
    var URL = window.UMEDITOR_HOME_URL || (function () {
        ...
        function PathStack() {
            ...
            //this.documentURL = "/bower_components/umeditor/";
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: '/carrots-admin-ajax/a/u/img/task' //图片上传提交地址
        , imagePath: '/carrots-admin-ajax/a/u/img/task'                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
